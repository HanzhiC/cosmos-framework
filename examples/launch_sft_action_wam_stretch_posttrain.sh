...
# ============================================================================
# Structured-TOML launch for action_wam_stretch_posttrain.
#
# This trains a world-action-model (WAM) on a Stretch teleop LeRobot dataset
# produced by `python -m cosmos_framework.scripts.convert_stretch_to_lerobot`.
# Given only the first video frame, the model jointly denoises the future
# video AND the matching future actions (no clean actions are given) — used at
# inference as an action-prediction policy. See docs/action_wam_stretch_posttrain.md.
#
...
TOML_FILE="examples/toml/sft_config/action_wam_stretch_posttrain.toml"
