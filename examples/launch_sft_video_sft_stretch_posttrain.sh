...
# ============================================================================
# Structured-TOML launch for video_sft_stretch_posttrain.
#
# This trains PURE video generation (no action supervision) on a Stretch
# teleop LeRobot dataset produced by
# `python -m cosmos_framework.scripts.convert_stretch_to_lerobot`. Reuses the
# action_fd_stretch_posttrain dataset/model shape with the action masked to
# zero (mask_action=True) — first-frame-conditioned (I2V-style) generation,
# not multi-frame V2V prefix continuation. See docs/video_sft_stretch_posttrain.md.
#
...
TOML_FILE="examples/toml/sft_config/video_sft_stretch_posttrain.toml"
