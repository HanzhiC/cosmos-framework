...
# ============================================================================
# Structured-TOML launch for video_sft_stretch_edge_lora_posttrain.
#
# Single-GPU (~48GB), Cosmos3-Edge + LoRA variant of video_sft_stretch_posttrain
# (pure video generation, no action supervision) on a Stretch teleop LeRobot
# dataset produced by `python -m cosmos_framework.scripts.convert_stretch_to_lerobot`.
# See docs/video_sft_stretch_posttrain.md (Edge + LoRA section).
#
...
TOML_FILE="examples/toml/sft_config/video_sft_stretch_edge_lora_posttrain.toml"
